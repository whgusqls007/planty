...
def connection_db():
    ...
    farm = pd.DataFrame(zeros, index=list(set(plant_like['user_id'])),
...
def get_recommendation_top_percent(uid, percent=10, ret_cnt=7):  # user_id , 유사한 사람 상위 몇퍼센트까지, 리턴될 식물개수
