...
from . import views
from .views import MagazineLikeViewSet, MagazineCommentViewSet, MainMagazineViewSet, MagazineImageUploadViewSet
...
urlpatterns = [
    ...
    path('image_upload/', MagazineImageUploadViewSet.as_view({'post': 'create'})),
