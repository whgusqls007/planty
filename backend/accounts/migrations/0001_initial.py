# Generated by Django 3.2.12 on 2022-09-19 08:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follows_count', models.IntegerField(default=0, verbose_name='팔로우 수')),
                ('articles_count', models.IntegerField(default=0, verbose_name='내가 쓴 글 수')),
                ('comments_count', models.IntegerField(default=0, verbose_name='내가 쓴 댓글 수')),
                ('likes_count', models.IntegerField(default=0, verbose_name='좋아요한 글 수')),
