...
class PlantsPlantkeyword(models.Model):
...
class RecommendationsUserkeywordcount(models.Model):
    ...
    pet_safe = models.IntegerField(blank=True, null=True)
    humidify = models.IntegerField(blank=True, null=True)
    pm_cleaning = models.IntegerField(blank=True, null=True)
    beginner = models.IntegerField(blank=True, null=True)
    unscented = models.IntegerField(blank=True, null=True)
    hydroponics = models.IntegerField(blank=True, null=True)
    low_growth_demand = models.IntegerField(blank=True, null=True)
    low_light_demand = models.IntegerField(blank=True, null=True)
